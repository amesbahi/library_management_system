...
module.exports = function(sequelize, DataTypes) {
  var Loan = sequelize.define('Loan', {
    ...
    loaned_on: { type: DataTypes.INTEGER , validate: { notEmpty: {msg: 'You must add a loaned on date!'} } },
    return_by: { type: DataTypes.INTEGER , validate: { notEmpty: {msg: 'You must add a return by date!'} } },
